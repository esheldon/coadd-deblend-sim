...
class CoaddImages():
    ...
    def _set_coadd_obs(self):
        ...
        #self.canonical_center = trueCenter()
        self.canonical_center = tim.center()
        self.canonical_center = galsim.PositionD(self.canonical_center.x, self.canonical_center.y)
